/**
 * Acento (color base) configurable. Deriva `--primary-strong/soft/on-primary`
 * desde un hex base calculando luminancia (WCAG) para asegurar contraste del
 * texto en ambos temas. Puro y testeable. Ver docs/DESIGN_SYSTEM.md §2.
 *
